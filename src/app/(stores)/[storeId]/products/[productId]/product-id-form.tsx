...
//   // price
//   const amount = initData?.arrayPrice.map((item) => item.price);
//   let defaultValueListAmount: Array<any> = createListDefaultValueForm(numSize, "price", 0);
...
//       const { [sizeIndex]: a, [colorIndex]: b, [priceIndex]: c, ...cleanFormValue } = form.getValues();
//       form.reset({
//         ...cleanFormValue,
//       });
//     }
